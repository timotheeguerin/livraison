...
impl<W: Read + Write + Seek> MsiInstallerPacker<W> {
    ...
    fn create_control_table(&mut self, _cabinets: &[CabinetInfo]) -> LivraisonResult<()> {
        ...
        // }
        // self.package
        //     .insert_rows(msi::Insert::into("Control").rows(rows))?;
        Ok(())
    }
